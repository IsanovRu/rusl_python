...
# этого проекта — одежда, которая может иметь определенное название. К типам одежды в этом
...
class Clothes():
    ...
    @abstractmethod #  абстрактный
    def abstract(self):
        return ' абстрактный метод декоратора @property'
